...
def enhance_maps(json_path: Path,
    ...
    try:
        ...
        if not skip_svg:
            ...
            try:
                svg_gen = MermaidSVGGenerator(dark_mode=dark_mode)
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  # Basic usage - enhance all formats
  ...
  # Exclude endpoints and use light mode
  %(prog)s topology.json --no-endpoints --light-mode
